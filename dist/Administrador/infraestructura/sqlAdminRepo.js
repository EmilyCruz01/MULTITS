...
class SqlAdminRepositorio {
    addAdmin(nombre, password) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const adminCreado = yield adminModel_1.default.create({ nombre, password });
                return new admin_1.Admin(adminCreado.nombre, adminCreado.password);
            }
            catch (error) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (getIdAdmin) {
                    ...
                    return new admin_1.Admin(getIdAdmin.nombre, getIdAdmin.password);
                }
                else {
                    return null;
                }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (adminEliminado) {
                    ...
                    return new admin_1.Admin(adminEliminado.nombre, adminEliminado.password);
                }
                else {
                    return null;
                }
